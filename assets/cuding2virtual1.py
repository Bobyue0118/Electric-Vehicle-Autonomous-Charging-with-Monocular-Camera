...
np.save("M_object2base_cu_1018", M_object2base)



poses_virtual2base =  [ ( 0.161099 ,0.567812,0.298047, -117.103, -0.250, -1.742 )]
R_virtual2base = []
...
# 中心点和虚拟点的变换关系
M_object2base = np.load('M_object2base_cu_1018.npy')
M_virtual2object=np.linalg.inv(M_object2base)@M_virtual2base

np.save('M_virtual2object_cu_1018.npy',M_virtual2object)
