...
def cu_predict(loc,ori,pose):
    ...
    M_camera2gripper = np.load(r'parameters\M_camera2gripper_4k_1212.npy')
    ...
    M_virtual2object = np.load(r'1018\parameters\M_virtual2object_cu_1018.npy')
